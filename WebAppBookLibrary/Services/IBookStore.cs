...
{
    Task<PagedResult<BookCatalogEntry>> SearchAsync(NormalizedBookQuery query, bool includeInactive, CancellationToken cancellationToken);
    Task<BookCatalogEntry?> FindCatalogEntryAsync(string id, bool includeInactive, CancellationToken cancellationToken);
    ...
    Task<bool> ReplaceMetadataAsync(Book book, CancellationToken cancellationToken);
